import { receiptCreationSerializer, receiptMyListSerializer } from "../serializers/receiptSerializer";
...
export class ReceiptController {
  ...
  async save(req, res) {
    try {
      const validatedBody = await receiptCreationSerializer.validateAsync(req.body);
